...
{
    public class ChatHub : WebSocketHub
    {
        public ChatHub(
        ...
        {
            Console.WriteLine("User: " + Context.UserId + " joined the group: " + groupId);
            Groups.Join(groupId);
        }
        ...
        {
            Console.WriteLine("User: " + Context.UserId + " left the group: " + groupId);
